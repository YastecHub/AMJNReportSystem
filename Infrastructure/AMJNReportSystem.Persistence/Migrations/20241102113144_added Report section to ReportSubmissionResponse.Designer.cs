...
namespace AMJNReportSystem.Persistence.Migrations
{
    ...
    [Migration("20241102113144_added Report section to ReportSubmissionResponse")]
    partial class addedReportsectiontoReportSubmissionResponse
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AMJNReportSystem.Domain.Entities.ReportResponse", b =>
                {
                    ...
                    b.HasOne("AMJNReportSystem.Domain.Entities.ReportSubmission", "ReportSubmission")
                        .WithMany("Answers")
