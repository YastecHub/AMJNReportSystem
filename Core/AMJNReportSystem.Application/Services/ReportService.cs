...
namespace AMJNReportSystem.Application.Services
{
    public class ReportService : IReportService
    {
        ...
        public ReportService(IReportRepository reportRepository, IReportTypeSectionRepository typeSectionRepository, IEncryptionService encryptionService, IQuestionRepository questionRepository, IReportDataSectionRepository reportDataSectionRepository)
        {
        ...
        public async Task<Result<bool>> SaveReport(ReportRequest request)
        {
            ...
            foreach (var section in request.SectionReports)
            {
                ...
                {
                    var reportDataSection = new ReportDataSection
                    {
                        ReportId = report.Id,
                        Report = report,
