...
namespace AMJNReportSystem.Application.Abstractions.Services
{
    ...
    public interface IReportTypeService
    {
        ...
        /// </summary>
        Task<Result<bool>> UpdateReportType(Guid reportTypeId, UpdateReportTypeRequest request);

        /// <summary>
        /// Method that get a particular report type, accepting the reportType Id as parameter
        /// </summary>
        Task<Result<ReportTypeDto>> GetReportType(Guid reportTypeId);

        /// <summary>
        /// Method that get all report types
        /// </summary>
        Task<Result<IEnumerable<ReportTypeDto>>> GetReportTypes();

        /// <summary>
        /// Method that get Qaid report types by report tag. use the enum directly
        /// </summary>
        Task<Result<IEnumerable<ReportTypeDto>>> GetQaidReportTypes();

        /// <summary>
        /// Method for update Activeness of Report-Type Activeness state, accepting Id and description as parameters by Admin only
        /// </summary>
        Task<Result<bool>> SetReportTypeActiveness(Guid reportTypeId, bool state);
